...
`define V5_MIG_INTERFACE_REG_SEL_CPU      3'b001  // cpu;
`define V5_MIG_INTERFACE_REG_SEL_MOTION   3'b010  // motion detection video cores;
`define V5_MIG_INTERFACE_REG_SEL_TEST     3'b100  // hw testing circuit;
